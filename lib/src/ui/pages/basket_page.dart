...
import 'package:pr_12/src/ui/components/basket_element.dart';
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                try {
                                  final basketItems = await _basket;
                                  const userId = 1;
                                  await ApiService().createOrder(basketItems, userId, priceSnapshot.data ?? 0.0);

                                  await ApiService().clearBasket(basketItems);
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                      ...
                                      content: const Text('Ваш заказ успешно отправлен, корзина очищена.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () => Navigator.of(context).pop(),
                                          child: const Text('OK'),
                              ...
                              child: Container(
                                ...
                                child: const Center(
                                  child: Text('Оформить заказ', style:
                                  TextStyle(
