...
import 'package:pr_12/src/ui/components/info.dart';
import 'package:pr_12/src/ui/pages/edit_game_page.dart';
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () async {
                  if (isFavorite) {
                    await ApiService().removeFromFavorites(game.id, '1');
                  } else {
                    await ApiService().addToFavorites(game.id, '1');
                  }
                  setState(() {
          ...
          Padding(
            padding: const EdgeInsets.only(top: 2.0, bottom: 10.0, right: 15.0, left: 15.0),
            child: GestureDetector(
              onTap: () async {
                final result = await Navigator.push(
                  context,
