...
// Получение элементов в корзине
  ...
  Future<void> clearBasket(List<BasketItem> basketItems) async {
    for (var item in basketItems) {
      await removeFromBasket(item.gameId);
    }
  }
  ...
  Future<void> createOrder(List<BasketItem> cartData, int userId, double total) async {
